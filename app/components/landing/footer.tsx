...
const links = {
  Produto: ["Funcionalidades", "Dashboard", "Planos", "API REST"],
    ...
    <footer className="border-t border-border/60 px-6 py-12">
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-3 max-w-xs text-sm leading-relaxed text-muted-foreground">
              Controle suas finanças pessoais com simplicidade e inteligência.
            </p>
          </div>
        ...
        <div className="flex flex-col items-center justify-between gap-4 text-sm text-muted-foreground md:flex-row">
          <p>2026 Fintra. Todos os direitos reservados.</p>
